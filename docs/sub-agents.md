...
- Has Codex added any session-to-session channel? The subagents page and the CLI reference's slash-command table are where it would surface first; both were still clean on 2026-08-19.
